...
public class LoadingProgressInfo extends JLabel {
	...
	private LoadingProgressInfo() {
		Loading_Frame_ProgressInfo_StandbyFontPath = GetParamentByName.GetParamentByKeyInSystemMemory("Loading_Frame_ProgressInfo_StandbyFontPath");
		Loading_Frame_ProgressInfo_FontName = GetParamentByName.GetParamentByKeyInSystemMemory("Loading_Frame_ProgressInfo_FontName");
		...
		loadingProgressInfoFont.deriveFont(Font.BOLD, 13);
	}
