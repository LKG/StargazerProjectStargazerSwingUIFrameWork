...
public class MouseAdapterListener extends MouseAdapter{
	...
	/**单例模式**/
	private static MouseAdapterListener mouseAdapterListener = null;

	public static MouseAdapterListener getInstance(Point origin){
		if(MouseAdapterListener.mouseAdapterListener == null){
			MouseAdapterListener.mouseAdapterListener = new MouseAdapterListener();
			mainJframeOrigin = origin;
		}
		return MouseAdapterListener.mouseAdapterListener;
	}
